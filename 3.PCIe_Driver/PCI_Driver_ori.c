...
#define PCITTL32IO_VENDOR_ID 0x8008   // Vendor_Id
#define PCITTL32IO_DEVICE_ID 0x3301   // Device_Id     

/* Meta Information */
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Swapnil PCI_Driver");
MODULE_DESCRIPTION("Driver for the General(PCITTL32IO) gpio card");
...
/* List known to user space and therefor */
